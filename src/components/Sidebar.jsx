            ...
            <div
                ...
                <ul className='pt-2'>
                    {Menus.map((item, index) => {
                        return (
                            <div key={index} >
                                <li className={`text-white text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-gray-50 hover:text-black hover:font-semibold rounded-md mt-2 hover:scale-105 transition duration-150 ease-in-out ${item.spacing ? "mt-9" : "mt-2"}`}>
                    ...
                    <li className={`absolute bottom-10  text-gray-300 text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:bg-gray-50 ${open ? "w-[85%]" : "w-[50%]"} hover:text-black hover:font-semibold mt-2 hover:scale-105 rounded-md transition duration-150 ease-in-out`} onClick={LogOut}>
